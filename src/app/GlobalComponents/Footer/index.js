    ...
    return (
        ...
        <div className="container mx-auto px-4 max-w-7xl mx-auto">
          <div className="flex flex-col md:flex-row md:inline-block">
           <div className="mb-4 md:mb-0 w-48 md:w-64 flex justify-center md:justify-start">
             <img
             src="./imagens/LogoFundoEscuroNum2.png"
             alt="Grupo Total Sistemas"
             className="w-48 md:w-80 object-contain scale-110"
             />
           </div>
