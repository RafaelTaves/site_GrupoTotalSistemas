...
export default function HomeBannerMobile() {
  return (
    <div
      className="xl:hidden relative w-full h-screen bg-cover bg-center"
    ...
    >
      <div className="absolute inset-0 bg-black bg-opacity-50 flex items-center justify-start px-8 md:px-16">
        <div className="text-white max-w-xl">
          <h1 className="text-4xl md:text-5xl lg:text-6xl text-sky-400 h4Headline lg:leading-relaxed">
            Somos o seu parceiro inovador, ágil e experiente em tecnologia e serviços de TI.
          </h1>
          <p className="mt-4 body1 lg:text-3xl leading-loose">
